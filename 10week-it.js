...
async function getAllRecords() {
  ...
  await fetch(
    `https://api.airtable.com/v0/app9L5qBODy38EOQj/10-week-it?&view=order`,
    options
  )
...
${
  thumbnail
    ...
    <p class="card-text"><i class="fa-solid fa-computer fa-2x"></i></p>
    <a href="10week-it.html?id=${
            data.records[i].id
  ...
  await fetch(
    ...
    <li>
                <a
                  ...
                  <a href="10week-it.html?id=${data.records[i].id}">&lt; ${name} &gt;</a
                >
              </li>
...
async function getOneRecord(id) {
  ...
  await fetch(
    `https://api.airtable.com/v0/app9L5qBODy38EOQj/10-week-it/${id}`,
    options
  )
    .then((response) => response.json())
    .then((data) => {
