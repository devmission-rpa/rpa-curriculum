...
async function getAllRecords() {
  ...
  await fetch(
    `https://api.airtable.com/v0/app9L5qBODy38EOQj/12-week-ccs?&view=order`,
    options
  )
  ...
  await fetch(
    ...
    <li>
                <a
                  ...
                  <a href="week-ccs.html?id=${data.records[i].id}">&lt; ${name} &gt;</a
                >
              </li>
...
async function getOneRecord(id) {
  ...
  await fetch(
    `https://api.airtable.com/v0/app9L5qBODy38EOQj/12-week-ccs/${id}`,
    options
  )
    .then((response) => response.json())
    .then((data) => {
